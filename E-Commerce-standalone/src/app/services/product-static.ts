...
export class ProductStatic {
  ...
  constructor() {
    ...
    getProductsId(prdId:number):Iproducts |undefined{
      return this.productsInService.find(obj =>  obj.productId == prdId);
    }
    getAllIds():number[]{
      return this.productsInService.map(prd=> prd.productId);
    }
